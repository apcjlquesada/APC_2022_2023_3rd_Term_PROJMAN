...
<div class="container">
    <div class="card card-body bg-light mt-3">
        <h1>
            <?php echo ($data["action"]=="add") ? "Registration" : "Update Customers's Information"  ?>
        </h1>
        <p><?php echo ($data["action"]=="add") ? "Input" : "Check" ?> your details below</p>
        <br/>
        <form action="<?php echo URLROOT ."/customers/".($data["action"]=="edit" ? "updateProfile" : "signup"); ?>" method="post">
